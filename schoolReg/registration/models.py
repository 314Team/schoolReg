...
class Student(models.Model):
    ...
    momPhone = models.CharField(max_length=20,blank=True)
    dad = models.CharField(max_length=50,blank=True)
    dadPhone = models.CharField(max_length=20,blank=True)
    
    birhDate = models.DateField()
    sex = models.BooleanField(null=True) #0-f 1-m n-nonbin
    grade = models.SmallIntegerField()
    address = models.CharField(max_length=100)    
    photo = models.ImageField(upload_to='students/photo/%Y/%m/',blank=True)
